...
/***/ function(module, exports, __webpack_require__) {
	...
	// var ScrollTrigger = require('../events/ScrollTrigger')
	var TopScene = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require$utils = __webpack_require__(7).utils;
	...
	var TopScene = function (_BaseApp) {
	    ...
	    _createClass(TopScene, [{
	        ...
	        value: function init() {
	            ...
	            $('#wrapper').on('click', '.media-photo', this.showModal.bind(this)).on('click', '.modal-layer .btn-close01', this.hideModal.bind(this));
	        }
