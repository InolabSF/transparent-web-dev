...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseApp = __webpack_require__(5);
	var data = __webpack_require__(10);
	// var FullBack = require('../utils/FullBack')
	// var YouTubeIframePlayer = require('../utils/YouTubeIframePlayer')
	// var Anchor = require('../utils/Anchor')

	var ACCESS_TOKEN = '7186207804.cc689a1.c6063a2e32dd452883f6b3c6b69e5b31';

	var Main = function (_BaseApp) {
	    _inherits(Main, _BaseApp);
	    ...
	    function Main() {
	        ...
	        $('#wrapper').on('click', '.instagram-photos .item', _this.showModal.bind(_this)).on('click', '.modal-layer .btn-close01', _this.hideModal.bind(_this)).on('click', '.modal-layer .modal-back', _this.hideModal.bind(_this));
	        return _this;
	    }
	    ...
	    _createClass(Main, [{
	        ...
	        value: function initInstagram() {
	            $.ajax({
	                ...
	                for (var i = 0, l = data.data.length; i < l; i++) {
	                    ...
	                    html += '<a href="' + d.link + '" style="background-image:url(' + d.images.standard_resolution.url + ')" ';

	                    if (d.type === 'video') {
	                        html += 'class="item type-video" data-video="' + d.videos.standard_resolution.url + '"';
	                    } else if (d.type === 'image') {
	                        html += 'class="item type-image" data-image="' + d.images.standard_resolution.url + '"';
	                    }
	        ...
	        value: function showModal(event) {
	            ...
	            if (image) {
	                $('<img />', { src: image }).appendTo(modal);
	            }
	            if (video) {
	                $('<video />', { src: video, autoplay: true }).appendTo(modal);
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require$utils = __webpack_require__(8).utils;

	var getHeight = _require$utils.getHeight;
	var getDOM = _require$utils.getDOM;
	var addClass = _require$utils.addClass;
	var removeClass = _require$utils.removeClass;
	var hasClass = _require$utils.hasClass;

	var _require = __webpack_require__(9);

	var AU_HEADER = _require.AU_HEADER;
	var STEP_HEADER = _require.STEP_HEADER;
	var ISSUN_SLIDER = _require.ISSUN_SLIDER;
	var NORMAL_SLIDER = _require.NORMAL_SLIDER;
	var UI_BUTTONS = _require.UI_BUTTONS;
	var COMPLETE_BUTTON = _require.COMPLETE_BUTTON;

	/**
	 * 基本機能を与える継承用クラス
	 */

	var BaseApp = function (_EventDispatcher) {
	    _inherits(BaseApp, _EventDispatcher);

	    function BaseApp() {
	        _classCallCheck(this, BaseApp);

	        var _this = _possibleConstructorReturn(this, (BaseApp.__proto__ || Object.getPrototypeOf(BaseApp)).call(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.utils = {
	     ...
	     * @return {number}     桁数を返す
	     */
	    getDigits: function getDigits(num) {
	     ...
	     * @return {number}     幅を返す
	     */
	    mb_strwidth: function mb_strwidth(str) {
	        var listen = void 0;
	     ...
	     * @return {string} 方向を返す
	     */
	    scrollDirection: function scrollDirection(event) {
	        var delta = void 0;
	     ...
	     * @param [object]  el  DOM要素
	     */
	    heightLine: function heightLine(el) {
	        var array = void 0,
	            height = void 0,
	            i = void 0,
	            len = void 0;
...
/***/ function(module, exports) {
	...
	module.exports = {
	    twitter: 'https://twitter.com/CloudBabyLove',
	    facebook: 'https://www.facebook.com/DOKI-DOKI-INC-1519179441630945/',
	    medium: 'https://medium.com/@dokidoki',
	    mail: 'mailto:hello@d0kid0ki.com'
	};
